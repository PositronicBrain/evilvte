...
#define COLOR_FOREGROUND       "SteelBlue"
...
#define FONT                   "DejaVu Sans Mono 15"
...
#define SCROLL_LINES           2048  /* Negative value means unlimited     */
...
#define MENU_CUSTOM            "Copy", "Separator", "Paste"
